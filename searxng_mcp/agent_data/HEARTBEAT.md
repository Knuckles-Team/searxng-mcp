...
5. **Domain-Specific Checks**:
   - **Weather Forecast**: Perform a quick check for severe weather alerts in your primary location.
   - **News Briefing**: Search for breaking news or top headlines related to predefined keywords (e.g., "Linux", "AI").
