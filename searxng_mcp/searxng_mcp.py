...
def searxng_mcp():
    parser = argparse.ArgumentParser(add_help=False, description="SearXNG MCP Server")
    parser.add_argument(
        "-t",
        "--transport",
...
def usage():
    print(
        f"Searxng Mcp ({__version__}): SearXNG MCP Server\n\n"
        "Usage:\n"
