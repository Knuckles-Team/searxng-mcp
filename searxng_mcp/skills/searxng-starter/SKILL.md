---
name: searxng-starter
description: >-
  Searxng API + MCP Server + A2A Server Use when working with Searxng via this package's MCP
...
license: MIT
tags: [searxng-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Searxng Starter Skill

Starter skill for the **Searxng** package. Use the `mcp-client` universal skill
