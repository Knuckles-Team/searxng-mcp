...
# Paths
ROOT_DIR = "/home/apps/workspace/agent-packages/agents/searxng-mcp"
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in searxng-mcp
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in searxng-mcp but are NOT registered "
